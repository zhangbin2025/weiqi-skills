...
# 限制下载数量
python3 download_by_name.py "星阵谈兵" --limit 10

# 指定保存目录
python3 download_by_name.py "星阵谈兵" --output-dir ~/Downloads/my_qipu

# 组合使用
python3 download_by_name.py "星阵谈兵" --limit 5 --output-dir /tmp/qipu
```
...
**API端点:**
- 用户查询: `GET https://newframe.foxwq.com/cgi/QueryUserInfoPanel?username={昵称}`
- 棋谱列表: `GET https://h5.foxwq.com/yehuDiamond/chessbook_local/YHWQFetchChessList?dstuid={UID}`
...
1. [2026-02-28 16:14:01] 星阵谈兵(业4段) vs 庆文笑傲(业4段)
   结果: 黑胜 (中盘) | 手数: 163 | ID: 1772266441030041221

2. [2026-02-24 19:49:39] 学习岳(业3段) vs 星阵谈兵(业4段)
   结果: 白胜 (中盘) | 手数: 244 | ID: 1771933779030031516

3. [2026-02-10 09:42:12] 星阵谈兵(业4段) vs 淡然13(业4段)
   结果: 黑胜 (中盘) | 手数: 109 | ID: 1770687732030051043

============================================================
⬇️  开始下载棋谱...
============================================================

[1/3] 下载 1772266441030041221 ... ✅ 已保存
[2/3] 下载 1771933779030031516 ... ✅ 已保存
[3/3] 下载 1770687732030051043 ... ✅ 已保存

============================================================
📈 下载报告
============================================================
   用户: 星阵谈兵 (UID: 532501283)
...
### v1.1.0 (2026-04-01)
- ✅ **新增通过昵称下载棋谱功能** - 无需知道UID，输入昵称即可下载
- ✅ 新增 `download_by_name.py` 脚本
- ✅ 支持查询用户基本信息（段位、战绩）
- ✅ 支持列出棋谱详情并批量下载
- ✅ 新增 API 端点：QueryUserInfoPanel、YHWQFetchChessList
