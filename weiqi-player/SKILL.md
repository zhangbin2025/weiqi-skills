---
name: weiqi-player
description: 查询围棋选手段位、等级分、排名信息，支持手谈等级分和易查分业余段位双平台查询。当用户需要"查棋手"、"等级分"、"段位查询"时使用此技能。
---
...
**张三** (深圳) | 段位: 6.2d | 等级分: 2500.0 | 全国排名: 1234 | 对局: 100局
   👉 [查看深圳详细记录](https://v.dzqzd.com/SpBody.aspx?r=...)
```
...
段位: 6段 | 等级分: 1700.00 | 总排名: 1000 | 地区: 广东 深圳 | 性别: 男 | 出生: 2010
...
1. **张三** (深圳) | 段位: 6.2d | 等级分: 2500.0 | 全国排名: 1234
   👉 [查看深圳详细记录](https://v.dzqzd.com/SpBody.aspx?r=...)

2. **张三** (广州) | 段位: 3.1d | 等级分: 2000.0 | 全国排名: 5678
   👉 [查看广州详细记录](https://v.dzqzd.com/SpBody.aspx?r=...)
```
...
- [深圳 9.9d 详细记录](https://v.dzqzd.com/SpBody.aspx?r=示例链接1)
- [广州 3.1d 详细记录](https://v.dzqzd.com/SpBody.aspx?r=示例链接2)
...
1. **同名选手处理**：
   - 手谈平台可能返回**多位同名选手**（如查询"张三"会返回深圳和广州两位）
   - 脚本会自动列出所有同名选手，按地区区分
   - 为每位选手生成独立的详细记录链接
   - 需根据地区/等级分判断目标选手
