...
使用方法:
    python3 query_player.py <姓名>
    python3 query_player.py --batch 姓名1 姓名2 姓名3
    
示例:
    python3 query_player.py 朱玲钰
    python3 query_player.py --batch 熊益成 田翔宇 宋夏
"""
...
def main():
    if len(sys.argv) < 2:
        print(__doc__)
        print("\n【单个查询】")
        print("  python3 query_player.py <姓名>")
        print("  示例: python3 query_player.py 朱玲钰")
        print("\n【批量查询】")
        print("  python3 query_player.py --batch 姓名1 姓名2 ...")
        print("  示例: python3 query_player.py --batch 熊益成 田翔宇 宋夏")
        sys.exit(1)
